...
const TaskRowAnimated = ({ style, id = 1 }) => {
  ...
  const baseGradientId = `baseGradient-${id}`;
    ...
    >
      <defs>
        ...
        >
          ...
          <feColorMatrix
            type="matrix"
            values="0 0 0 0 0.156863 0 0 0 0 0.0117647 0 0 0 0 0.0627451 0 0 0 0.15 0"
          />
      ...
      <g filter={`url(#${shadowId})`}>
        {/* Card background */}
        <path
          d="M8 16C8 9.37258 13.3726 4 20 4H357C363.627 4 369 9.37258 369 16V36C369 42.6274 363.627 48 357 48H20C13.3726 48 8 42.6274 8 36V16Z"
          fill="white"
        />
        ...
        {/* Line 2 */}
        <rect x="44" y="28" width="313" height="8" rx="4" fill={`url(#${baseGradientId})`} />
